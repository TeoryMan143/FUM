...
public class QuienesSomos extends JFrame{
    ...
    public QuienesSomos() {
        ...
        final String TXT_VISION = "Para el año 2044, ¡FUM! será una empresa reconocida a nivel nacional, ampliando su alcance y\n" +
                ...
                "la mejor calidad y servicio para nuestros visitantes, socios y sus familias. ¡Para ese entonces,\n" +
                "contará con nuevas atracciones enfocadas en la salud mental para hacer de FUM! un lugar de\n" +
